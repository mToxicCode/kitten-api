...
{
    private readonly IDbConnectionsFactory.IDbConnectionFactory _connectionFactory;

    public DbExecuteWrapper(IDbConnectionsFactory.IDbConnectionFactory connectionFactory)
